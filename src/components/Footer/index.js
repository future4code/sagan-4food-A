...
function Footer(props) {
  ...
  return (
    <FooterWrapper>
      ...
      <IconsDiv>
        <IconsWrapper onClick={props.goToHome}>
          <img
            src={require("./Images/homepage.png")}
            type="icon"
            alt="ícone clicável home"
          ></img>
        </IconsWrapper>

        <IconsWrapper onClick={props.goToCart}>
          <Badge badgeContent={itensCarrinho} color="secondary">
            <img
              src={require("./Images/shopping-cart.png")}
              type="icon"
              alt="ícone clicável carrinho de pedidos"
            ></img>
          </Badge>
        </IconsWrapper>

        <IconsWrapper onClick={props.goToUserProfile}>
          <img
            src={require("./Images/avatar.png")}
            type="icon"
            alt="ícone clicável meu perfil"
          ></img>
        </IconsWrapper>
      </IconsDiv>
    </FooterWrapper>
